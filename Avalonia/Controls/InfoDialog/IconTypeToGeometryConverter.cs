...
{
    private static readonly Geometry InfoGeometry = Geometry.Parse(
    ...
    private static readonly Geometry WarningGeometry = Geometry.Parse(
    ...
    {
        return value is IconType.Warning ? WarningGeometry : InfoGeometry;
    }
